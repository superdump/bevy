...
pub const MESH2D_VERTEX_OUTPUT: Uuid = Uuid::from_u128(7646632476603252194);
pub const MESH2D_VIEW_TYPES_UUID: Uuid = Uuid::from_u128(12677582416765805110);
pub const MESH2D_VIEW_BINDINGS_UUID: Uuid = Uuid::from_u128(6901431444735842434);
pub const MESH2D_TYPES_UUID: Uuid = Uuid::from_u128(8994673400261890424);
pub const MESH2D_BINDINGS_UUID: Uuid = Uuid::from_u128(8983617858458862856);
pub const MESH2D_FUNCTIONS_UUID: Uuid = Uuid::from_u128(4976379308250389413);
pub const MESH2D_SHADER_UUID: Uuid = Uuid::from_u128(2971387252468633715);
...
impl Plugin for Mesh2dRenderPlugin {
    ...
    fn finish(&self, app: &mut bevy_app::App) {
        ...
        load_internal_asset!(
            app,
            MESH2D_VIEW_TYPES_UUID,
            "mesh2d_view_types.wgsl",
            Shader::from_wgsl
        );
        load_internal_asset!(
            app,
            MESH2D_VIEW_BINDINGS_UUID,
        ...
        load_internal_asset!(
            app,
            MESH2D_FUNCTIONS_UUID,
            "mesh2d_functions.wgsl",
            Shader::from_wgsl
        );
        load_internal_asset!(app, MESH2D_SHADER_UUID, "mesh2d.wgsl", Shader::from_wgsl);

        // Load the mesh_bindings shader module here as it depends on runtime information about
        // whether storage buffers are supported, or the maximum uniform buffer binding size.
        load_internal_asset!(
            app,
            MESH2D_BINDINGS_UUID,
...
pub struct Mesh2dPipeline {
    ...
    pub mesh2d_shader_handle: Handle<Shader>,
}
...
impl FromWorld for Mesh2dPipeline {
    fn from_world(world: &mut World) -> Self {
        ...
        let (render_device, render_queue, default_sampler, internal_assets) =
        ...
        let mesh2d_shader_handle = internal_assets
            .get(&MESH2D_SHADER_UUID)
            .expect("MESH2D_SHADER_UUID is not present in InternalAssets")
            .clone_weak();
...
impl GetBatchData for Mesh2dPipeline {
    ...
    type CompareData = (Material2dBindGroupId, AssetIndex);
...
impl SpecializedMeshPipeline for Mesh2dPipeline {
    ...
    fn specialize(
        ...
        Ok(RenderPipelineDescriptor {
            vertex: VertexState {
                shader: self.mesh2d_shader_handle.clone_weak(),
