#import bevy_pbr::{
    ...
    skinning,
    morph,
    mesh_view_bindings::{view, previous_world_to_ndc},
}
...
fn vertex(vertex_no_morph: Vertex) -> VertexOutput {
    ...
    out.position = mesh_functions::mesh_position_local_to_clip(local_to_world, vec4(vertex.position, 1.0));
    ...
    out.previous_world_position = mesh_functions::mesh_position_local_to_world(
        mesh_functions::get_previous_local_to_world_matrix(vertex_no_morph.instance_index),
...
#ifdef MOTION_VECTOR_PREPASS
    let clip_position_t = view.unjittered_world_to_ndc * in.world_position;
    let clip_position = clip_position_t.xy / clip_position_t.w;
    let previous_clip_position_t = prepass_bindings::previous_world_to_ndc * in.previous_world_position;
