...
use crate::*;
use bevy_asset::{io::embedded::InternalAssets, Asset, AssetIndex, AssetServer};
    ...
    fn build(&self, app: &mut App) {
        ...
        if let Some(render_app) = app.get_sub_app_mut(RenderApp) {
            render_app
                ...
                .add_systems(ExtractSchedule, extract_material_instances::<M>)
                .add_systems(
                    Render,
...
impl<P: PhaseItem, M: Material, const I: usize> RenderCommand<P> for SetMaterialBindGroup<M, I> {
    ...
    fn render<'w>(
        ...
        let Some(material_asset_index) = material_instances.get(&item.entity()) else {
            return RenderCommandResult::Failure;
        };
        let Some(material) = materials.get(*material_asset_index) else {
            return RenderCommandResult::Failure;
        };
...
pub fn extract_material_instances<M: Material>(
