...
impl Plugin for PbrPlugin {
    fn build(&self, app: &mut App) {
        #[cfg(not(feature = "bevy_shader_hot_reloading"))]
        {
            ...
            shaders.set_untracked(
                ...
                Shader::from_wgsl(include_str!(
                    "../../../assets/shaders/bevy_pbr/pbr_types.wgsl"
                ))
            ...
            shaders.set_untracked(
                PBR_BINDINGS_HANDLE,
                Shader::from_wgsl(include_str!(
                    "../../../assets/shaders/bevy_pbr/pbr_bindings.wgsl"
                ))
            ...
            shaders.set_untracked(
                ...
                Shader::from_wgsl(include_str!(
                    "../../../assets/shaders/bevy_pbr/pbr_functions.wgsl"
                ))
        ...
        #[cfg(feature = "bevy_shader_hot_reloading")]
        {
            ...
            let pbr_types_handle: Handle<Shader> =
                asset_server.load("shaders/bevy_pbr/pbr_types.wgsl");
            let pbr_bindings_handle: Handle<Shader> =
                asset_server.load("shaders/bevy_pbr/pbr_bindings.wgsl");
            let pbr_functions_handle: Handle<Shader> =
                asset_server.load("shaders/bevy_pbr/pbr_functions.wgsl");
            ...
            hot_reload_shaders
                .add_hot_reload_shader(pbr_types_handle, PBR_TYPES_IMPORT_PATH.to_string());
            hot_reload_shaders
                .add_hot_reload_shader(pbr_bindings_handle, PBR_BINDINGS_IMPORT_PATH.to_string());
            hot_reload_shaders
                .add_hot_reload_shader(pbr_functions_handle, PBR_FUNCTIONS_IMPORT_PATH.to_string());
