use crate::{
    ...
    MaterialBindGroupIds, NotShadowCaster, NotShadowReceiver, PreviousGlobalTransform,
...
pub fn extract_meshes(
    ...
    mut material_bind_group_ids: ResMut<MaterialBindGroupIds>,
...
pub fn extract_skinned_meshes(
    ...
    for (entity, view_visibility, skin) in &query {
            ...
            SkinnedMeshJoints::build(skin, &inverse_bindposes, &joint_query, &mut uniform.buffer)
        {
            ...
            skinned_mesh_joints_instances.insert(
                #[cfg(feature = "render_sparseset")]
                entity,
                #[cfg(not(feature = "render_sparseset"))]
                entity,
...
impl GetBatchData for MeshPipeline {
    type Param = (SRes<RenderMeshInstances>, SRes<MaterialBindGroupIds>);
    type Query = (Entity, With<Mesh3d>);
...
impl<P: PhaseItem> RenderCommand<P> for DrawMesh {
    ...
    fn render<'w>(
        ...
        let Some(gpu_mesh) = meshes.get(&mesh_instance.handle) else {
            return RenderCommandResult::Failure;
        };
