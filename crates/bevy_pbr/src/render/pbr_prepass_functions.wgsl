...
#import bevy_pbr::{
    ...
    prepass_bindings::previous_world_to_ndc,
...
fn calculate_motion_vector(world_position: vec4<f32>, previous_world_position: vec4<f32>) -> vec2<f32> {
    let clip_position_t = view.unjittered_world_to_ndc * world_position;
    let clip_position = clip_position_t.xy / clip_position_t.w;
    let previous_clip_position_t = previous_world_to_ndc * previous_world_position;
