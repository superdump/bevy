...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('sprite_pipelined_bg.wasm', import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
