...
use bevy_render2::{
    ...
    render_phase::{
        sort_phase_system, DrawFunctionId, DrawFunctions, EntityPhaseItem, PhaseItem,
...
impl RenderCommand<Opaque3d> for SetItemPipeline {
...
impl RenderCommand<AlphaMask3d> for SetItemPipeline {
    type Param = SRes<RenderPipelineCache>;
    #[inline]
    fn render<'w>(
        _view: Entity,
